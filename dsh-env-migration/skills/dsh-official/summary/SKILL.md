...
```bash
if [ ! -f "C:/Users/10905/claude-paper/plugin/.installed" ]; then
  echo "First run - installing dependencies..."
  cd "C:/Users/10905/claude-paper/plugin"
  npm install || exit 1

  # Install Python dependencies for image extraction
  C:/Users/10905/miniconda3/python.exe -m pip install pymupdf --user 2>/dev/null || pip3 install pymupdf --user 2>/dev/null || echo "Warning: Failed to install pymupdf"

  touch "C:/Users/10905/claude-paper/plugin/.installed"
...
```bash
mkdir -p D:/claude-papers/papers/{paper-slug}
```
...
3. **File location reminder:**
   - Summary saved to: `D:/claude-papers/papers/{paper-slug}/quick-summary.md`
