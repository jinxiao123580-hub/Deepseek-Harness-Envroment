...
export const jobMarketSkill = {
    name: 'job-market',
    description: '基于真实招聘岗位的市场需求分析与学习路线规划：自动采集岗位、跨平台去重、结构化解析 JD、技能标准化、统计市场需求与共现、维护个人技能画像、计算能力差距与学习优先级，并生成 4/8/12 周学习路线。只做市场分析与学习规划，不做自动投递。',
    whenToUse: '当用户想了解某类岗位的真实市场需求、想知道自己与市场的能力差距、想生成或调整学习计划、想更新求职市场数据时使用。例如「分析一下现在机器人软件岗位需要什么」「根据目前岗位市场给我生成未来8周学习计划」「更新一下求职市场」。',
    source: 'runtime',
    content: `
...
//# sourceMappingURL=job-market.skill.js.map