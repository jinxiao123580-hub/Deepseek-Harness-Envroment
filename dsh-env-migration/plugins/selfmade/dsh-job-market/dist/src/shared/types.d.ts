...
export type KnownJobCategory = 'robotics-software' | 'robotics-control' | 'ros2' | 'embedded' | 'motion-planning' | 'slam' | 'perception' | 'rl-embodied' | 'unknown';
...
/** 技能大类。允许自定义扩展。 */
export type KnownSkillCategory = 'Programming' | 'Robotics' | 'Embedded' | 'Control' | 'Planning' | 'SLAM' | 'Perception' | 'AI/RL' | 'Linux' | 'Engineering' | 'Hardware' | 'Communication';
