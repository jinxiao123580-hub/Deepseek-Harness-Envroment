...
export const assertAllowedDomain = (domain, index) => {
...
export const assertUrlAllowed = (value, allowedDomains) => {
    let url;
    try {
        url = new URL(value);
    }
...
export const assertNoUnsafeRequestAction = (request) => {
...
const resolveAllowedDomains = (config) => {
    const rawDomains = [
